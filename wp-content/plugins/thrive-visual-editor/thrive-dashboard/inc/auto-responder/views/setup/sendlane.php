...
<div class="tvd-row">
	<form class="tvd-col tvd-s12">
		...
		<div class="tvd-input-field">
			...
			<label for="tvd-sl-api-url"><?php echo __( 'API URL', TVE_DASH_TRANSLATE_DOMAIN ) ?></label>
		</div>
		<div class="tvd-input-field">
			<input id="tvd-sl-api-key" type="text" name="connection[api_key]"
				   value="<?php echo $this->param( 'api_key' ) ?>">
			<label for="tvd-sl-api-key"><?php echo __( 'API key', TVE_DASH_TRANSLATE_DOMAIN ) ?></label>
		</div>
        <div class="tvd-input-field">
			<input id="tvd-sl-hash-key" type="text" name="connection[hash_key]"
				   value="<?php echo $this->param( 'api_key' ) ?>">
			<label for="tvd-sl-hash-key"><?php echo __( 'HASH key', TVE_DASH_TRANSLATE_DOMAIN ) ?></label>
		</div>
	</form>
</div>
